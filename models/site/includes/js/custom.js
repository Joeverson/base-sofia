...
/* ---------------------------------------------------------------------- */
	...
	$.include('models/includes/js/jquery.easing.1.3.js');
	$.include('models/includes/js/jquery.cycle.all.min.js');
	$.include('models/includes/js/respond.min.js');
	
	if(jQuery("html").is(".ie8")) {
		$.include('models/includes/js/selectivizr-and-extra-selectors.min.js')
	}
	
	if(jQuery('#portfolio-items').length) {$.include('models/includes/js/jquery.isotope.min.js');}
	if(jQuery('.single-image').length) {$.include('models/includes/fancybox/jquery.fancybox.pack.js');}
	if(jQuery('#jstwitter').length) {$.include('models/includes/js/twitter.js');}
...
jQuery(document).ready(function($) {
	...
	if ($('#slider').length) {
		$.include('models/includes/sliders/flexslider/jquery.flexslider-min.js');
	...
	(function() {
		...
		if($('#map').length) {
			$('#map').gMap({ 
				address: 'Agua Branca, PB',
				zoom: 15,
				markers: [
					{'address' : 'R. Maj. Inocêncio'}
				]
			});  
		}
